...
class Destination {
  ...
  Destination(this.name, this.image, this.description);
}
...
List<Destination> fakeData = [
  ...
  Destination(
      ...
      "Land of stunning landscapes from mountains to beaches. Famous for Lord of the Rings filming locations and Maori culture.")
];
